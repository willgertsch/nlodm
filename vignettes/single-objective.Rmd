...
According to Atkinson, these designs all have fewer than 3 design points, which means they are impossible to find using the standard c-criterion. Let's try the Bayesian designs suggested later in the book in section 18.4.
